...
public class MessagePropertyHelperMain {
    ...
    public void main() {
        ...
        // Map<Message, PropertyKey> generatedResult = generator.generate(failuerResults, messagePropertiesFilePath);
...
//        MessageSearchManager searchManager = new MessageSearchManager();
//        searchManager.findFromResourceFile();
    }
}
